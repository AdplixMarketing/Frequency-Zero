...
const PUZZLES = {
    ...
    movies: {
        ...
        medium: [
            ...
            { id: 'm39', emojis: ['🦅', '🏃'], answer: 'The Shawshank Redemption', hints: ['Prison', 'Hope', 'Morgan'] },
            { id: 'm40', emojis: ['🎻', '📋'], answer: 'Schindlers List', hints: ['WW2', 'Holocaust', 'Spielberg'] },
        ...
        hard: [
            ...
            { id: 'm56', emojis: ['🌧️', '🏃‍♂️', '🔪'], answer: 'Blade Runner', hints: ['Sci-fi', 'Replicant', 'Ford'] },
            ...
            { id: 'm63', emojis: ['💺', '✈️', '🥊'], answer: 'Fight Club', hints: ['Pitt', 'Norton', 'Underground'] },
            ...
            { id: 'm67', emojis: ['🎭', '🔥', '🌿'], answer: 'There Will Be Blood', hints: ['Oil', 'Daniel', 'Milkshake'] },
            ...
            { id: 'm70', emojis: ['🔫', '🌹'], answer: 'Guns N Roses', hints: ['Band', 'Rock', 'Axl'] },
        ],
    },
    ...
    songs: {
        easy: [
            ...
            { id: 's8', emojis: ['💛', '🚕'], answer: 'Yellow Taxi', hints: ['Joni', 'Mitchell', 'Folk'] },
        ...
        medium: [
            ...
            { id: 's21', emojis: ['🌹', '🔫'], answer: 'Guns and Roses', hints: ['Band', 'Rock', 'Axl'] },
