...
const PUZZLES = {
    ...
    movies: {
        ...
        medium: [
            ...
            { id: 'm32', emojis: ['👑', '🦍'], answer: 'King Kong', hints: ['Monster', 'Empire State', 'Ape'] },
    ...
    tvshows: {
        ...
        medium: [
            ...
            { id: 't29', emojis: ['💛', '🪨'], answer: 'Yellowstone', hints: ['Paramount', 'Ranch', 'Montana'] },
        ...
        hard: [
            ...
            { id: 't36', emojis: ['👯', '🏔️'], answer: 'Twin Peaks', hints: ['ABC', 'Lynch', 'Mystery'] },
    ...
    songs: {
        easy: [
            { id: 's1', emojis: ['1️⃣', '👩', '👩', '👩'], answer: 'Single Ladies', hints: ['Beyonce', 'Ring', 'Dance'] },
            ...
            { id: 's13', emojis: ['🛣️', '🚗'], answer: 'Life is a Highway', hints: ['Cars', 'Rascal', 'Flatts'] },
        ...
        hard: [
            ...
            { id: 's33', emojis: ['📹', '🔪', '📻', '⭐'], answer: 'Video Killed the Radio Star', hints: ['Buggles', 'MTV', '80s'] },
            ...
            { id: 's37', emojis: ['🔄', '🌊'], answer: 'Rolling in the Deep', hints: ['Adele', '2010s', 'Soul'] },
